                  ...
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Brand Study</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Market Study</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Marketing Calendar</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Content Creation</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Design Creation</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Posting</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">AI Performance Monitoring</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">KPI Reporting</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Contests & Giveaways</h2>
                        </div>
                      </div>
                    </a>
                  </div>
