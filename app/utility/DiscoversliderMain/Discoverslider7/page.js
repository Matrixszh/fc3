                  ...
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Event Planning</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Event Operating</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Event Supervision</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Manpower</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Crowd Management</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Food & Beverage</h2>
                        </div>
                      </div>
                    </a>
                  </div>
