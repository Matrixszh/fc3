                  ...
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Brand Architecture Structuring</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Heirarchy Structuring</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Operations Manual</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Employee Handbook</h2>
                        </div>
                      </div>
                    </a>
                  </div>
