              ...
              <div className="swiper-wrapper">
                ...
                >
                  <div className="inner">
                    ...
                    <Link href="/utility/DiscoversliderMain/Discoverslider10">DISCOVER CASE</Link>
                  </div>
                  {/* end inner */}
                </div>
                {/* end swiper-slide */}
                ...
                >
                  <div className="inner">
                    <h2>VISUALIZE THE JOURNEY</h2>
                    <Link href="/utility/DiscoversliderMain/Discoverslider11">DISCOVER CASE</Link>
                  </div>
                  {/* end inner */}
                </div>
                {/* end swiper-slide */}
