              ...
              <div className="swiper-wrapper">
                ...
                >
                  <div className="inner">
                    ...
                    <Link href="/utility/Discoverslider2">DISCOVER CASE</Link>
                  </div>
                  {/* end inner */}
                </div>
                {/* end swiper-slide */}
                ...
                >
                  <div className="inner">
                    ...
                    <Link href="/utility/Discoverslider1">DISCOVER CASE</Link>
                  </div>
                  {/* end inner */}
                </div>
                {/* end swiper-slide */}
                ...
                >
                  <div className="inner">
                    ...
                    <Link href="/utility/Discoverslider3">DISCOVER CASE</Link>
                  </div>
