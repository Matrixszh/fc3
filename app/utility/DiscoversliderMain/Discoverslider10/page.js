                  ...
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Product Photography</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Lifestyle Photography</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Portrait Photography</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Architecture Photography</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Automotive Photography</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Events Photography</h2>
                        </div>
                      </div>
                    </a>
                  </div>
