                  ...
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Research & Selection</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Outreach & Negotiation</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Campaign Strategy & Planning</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Media Kit Creation</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Campaign Management Monitoring </h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        ...
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Performance Reporting</h2>
                        </div>
                      </div>
                    </a>
                  </div>
