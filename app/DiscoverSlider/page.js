                ...
                <div className="swiper-wrapper">
                    ...
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        <div className="slide-text-wrap">
                          <div className="slide-category">Photography1</div>
                        </div>
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Proximity1</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        <div className="slide-text-wrap">
                          <div className="slide-category">Photography2</div>
                        </div>
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Common Region2</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        <div className="slide-text-wrap">
                          <div className="slide-category">Photography3</div>
                        </div>
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Common Fate3</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        <div className="slide-text-wrap">
                          <div className="slide-category">Photography4</div>
                        </div>
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Continuity4</h2>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div className="swiper-slide">
                    <a href="#" className="slide-content w-inline-block">
                      ...
                      <div className="slide-inner">
                        <div className="slide-text-wrap">
                          <div className="slide-category">Photography5</div>
                        </div>
                        <div className="slide-text-wrap">
                          <h2 className="slide-heading">Similarity5</h2>
                        </div>
                      </div>
                    </a>
                  </div>
